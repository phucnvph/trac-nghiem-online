 ...
 * File này nhận webhook từ SePay khi có giao dịch thanh toán
 */
...
error_log("SePay Webhook received: " . $input);
...
try {
    ...
    $sql = "INSERT INTO sepay_transactions 
            (gateway, transaction_date, account_number, sub_account, amount_in, accumulated, 
             code, transaction_content, reference_number, body, created_at) 
            VALUES 
            (:gateway, :transaction_date, :account_number, :sub_account, :amount_in, :accumulated, 
             :code, :transaction_content, :reference_number, :body, NOW())";
